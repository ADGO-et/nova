...
const page = () => {
  return (
    <div className='text-background'>
      <div className="flex flex-col justify-center p-12 items-center w-full h-[250px] md:h-[300px] bg-cover opacity-80 bg-center gap-4 md:gap-12" style={{ backgroundImage: 'url(/pricing/bgBanner.png)' }}>
