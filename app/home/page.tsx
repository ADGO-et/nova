...
const page = () => {
  return (
    <div>
      <div className="flex flex-col justify-center p-12 items-center w-full h-[250px] md:h-[570px] bg-cover opacity-80 bg-center my-4 gap-4 md:gap-12" style={{ backgroundImage: 'url(/home/bgBanner.png)' }}>
