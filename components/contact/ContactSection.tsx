  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 bg-foreground">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl shadow-lg rounded-lg overflow-hidden">
        <div className="bg-blue-600 text-white w-full md:w-1/2 p-8">
        ...
        <span className="hidden md:block absolute z-50 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black font-semibold items-center text-white p-2 rounded-full">or</span>
        <div className="relative w-full md:w-1/2 bg-gray-100 flex flex-col justify-center p-6">
