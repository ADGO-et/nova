...
const RequestQuote: React.FC = () => {
  return (
    <div
      className="flex flex-col items-center justify-center p-6 md:p-12 w-[75%] h-auto bg-cover bg-center my-8 mx-auto rounded-xl shadow-2xl"
    ...
    >
      ...
      <div className="w-full max-w-2xl bg-foreground shadow-lg rounded-xl overflow-hidden my-12">
          ...
          <form className="grid md:grid-cols-2 gap-4 my-8">
            <div>
              ...
              <input
                ...
                className="mt-1 p-2 w-full border border-gray-400 rounded-md bg-foreground"
              />
            </div>
            <div>
            ...
            <div className="col-span-2">
              ...
              <textarea
                placeholder="Message"
                className="mt-1 p-2 w-full border border-gray-400 rounded-md h-24 bg-foreground"
              ></textarea>
            </div>
