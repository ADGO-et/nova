      ...
      <div className="container mx-auto w-[80%] py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center p-6 rounded-xl ">
            <Image src="/innovation.svg" alt="Innovation Icon 1" width={110} height={110} className="mb-4 hover:animate-spin" />
          ...
          <div className="flex flex-col items-center p-6 rounded-xl ">
            <Image src="/reliable.svg" alt="Innovation Icon 1" width={110} height={110} className="mb-4 hover:animate-spin" />
          ...
          <div className="flex flex-col items-center p-6 rounded-xl ">
            <Image src="/customization.svg" alt="Innovation Icon 1" width={110} height={110} className="mb-4 hover:animate-spin" />
